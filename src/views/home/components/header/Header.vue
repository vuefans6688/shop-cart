<template>
  <div class="wrapper" :style="showBackground ? 'background-color: white;' : ''">
    <div class="location-wrapper" ref="location">
      <svg viewBox="0 0 30 30" class="icon icon-location">
        <path fill="#FFFFFF"
          fill-rule="evenodd"
    ...
    <div class="search-wrapper"
      ...
      <div class="search-content">
        <div class="icon-search-wrapper">
          <svg viewBox="0 0 32 32" class="icon icon-search">
            <path fill="#999"
              fill-rule="evenodd"
        ...
        <span class="search-prompt">{{ $t('home.inputGoodsName') }}</span>
      </div>
    </div>
  </div>
</template>
...
.location-wrapper .icon-arrow {
  vertical-align: middle;
}

.location-wrapper.wheel {
  opacity: 0;
