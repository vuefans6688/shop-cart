            ...
            <van-cell>
              ...
              <template slot="title">
                <span class="custom-title">
                  ...
                  <p class="sub-title">{{ list[0].address }}</p>
                </span>
              </template>
            </van-cell>
          </van-cell-group>
          ...
          <van-cell-group :title="$t('home.nearbyAddress')">
            <ul>
              <li class="near-lists"
                ...
                <p class="
                  title">{{ item.name }}</p>
                <p class="sub-title">{{ item.address }}</p>
              </li>
            </ul>
          </van-cell-group>
        </ul>
...
export default {
  ...
  methods: {
    ...
    onSearchResult (pois) {
      ...
      let lngSum = 0
      let me = this
      let mymap = me.$refs.map.$$getInstance()
    ...
    $Geocoder (options) {
      ...
      if (AMap) {
        AMap.plugin(['AMap.Geocoder'], () => {
          ...
          let lnglatXY = options.lnglatXY || [114.397169, 30.50576] //已知点坐标
