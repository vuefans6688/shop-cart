<template>
  <div id="order">
    ...
    <van-cell-group>
      ...
      <div class="wrapper"
           @click="goToGoodsList">
        <div class="product-image-wrapper" ref="productImageWrapper">
          <ul class="image-wrapper" ref="imageWrapper">
            <li ref="subWrapper"
    ...
    <van-cell-group style="margin-top: 0.6rem">
      ...
      <van-cell>
        ...
        <span slot="title">{{ $t('order.use') }}{{ integral }}{{ $t('order.aliPay') }}
    ...
    <van-cell-group style="margin-top: 0.6rem">
      ...
      <van-cell :title="$t('order.point')" v-show="isShowPreferential">
        <div class="integral-to-money">-{{ integralToprice | moneyFormat }}</div>
      </van-cell>
    </van-cell-group>
