  ...
  <div class="cart">
    ...
    <header class=" title-wrapper">
      ...
      <div class="clear-cart"
        ...
        @click="clearCart"
        v-show="isShowEmptyCart">{{ $t('car.delete') }}
      </div>
    </header>
    <!-- 购物车没有商品 -->
    <div class="cart-wrapper">
      <!-- 购物车为空 -->
      <div class="empty-cart" v-if="!isShowEmptyCart">
        <img src="./../../images/cart/empty.png" alt="">
        <div class="title">{{ $t('car.tip') }}</div>
        <router-link to="/dashboard/home" class="go-home">{{ $t('car.walk') }}</router-link>
      </div>
      <!-- 购物车有数据 -->
      <div class="content-wrapper"
        ...
        <div class="content-wrapper-list"
          ...
          :key="goods.id">
          <section>
            <div class="shop-cart-list-content">
              <div class="left">
                <a href="javaScript:;"
              ...
              <div class="right">
                ...
                <div class="bottom-content">
                  <p class="shop-price"> {{ goods.price | moneyFormat }}</p>
                  <div class="shop-deal">
